    ...
    {!isLoading && (
     <Card className="mb-2">
      <div>
       <Card.Img
        variant="top"
        src="https://wallpapers.com/images/high/ubuntu-4k-5120-x-2880-uwdo176k9rm0tojp.webp"
        style={{ height: "14em" }}
       />
       <div className=" ">
          ...
          <Col md={8}>
           <div>
            <div className="d-flex">
             ...
             <Button
              className="ms-3 rounded-pill"  style={{ fontSize: '1rem', padding: '0 8px 0 8px' }}
      ...
      <div className="d-flex ms-3 mb-3 ">
       ...
       <div className="border rounded m-0 p-2 d-flex me-3">
        <div className="d-flex">
         <a className="text-decoration-none" href="">
          <strong className=" text-body-secondary">
           Fai sapere che stai cercando lavoro
          </strong>
          <p className="text-body-tertiary">e trova il tuo prossimo impiego dei sogni</p>
