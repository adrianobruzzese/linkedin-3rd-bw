    ...
    <>
      <Card>
        <Card.Body>
          ...
          <p className="d-flex align-items-center">
            <i className="bi bi-journal-check fs-4 me-1"></i> Valutazioni delle
            competenze
          </p>
          <p className="d-flex align-items-center">
            <i className="bi bi-play-btn-fill fs-4 me-1"></i>Indicazioni per chi
            cerca lavoro
          </p>
          <p className="d-flex align-items-center">
      ...
      <div>
        ...
        >
          <i className="bi bi-pencil-square me-3"></i>Pubblica offerta gratuita
        </Button>
      </div>
    </>
  );
